...
<head>
    ...
    <title>Cetak Laporan Peminjaman - Petugas</title>
...
<body>
    <div class="content-wrapper">
        ...
        <div class="print-header">
            ...
            <p class="print-subtitle">Sistem Peminjaman Alat - Petugas Panel</p>
            <p class="print-subtitle">Laporan lengkap peminjaman alat yang telah diproses</p>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($row['kondisi_kembali'] ?? $row['kondisi'] ?? '-'); ?></td>
                        <td>
    ...
    <script>
        ...
        window.addEventListener('beforeprint', function() {
            document.title = "Laporan Peminjaman - Petugas - " + new Date().toLocaleDateString();
        });

        window.addEventListener('afterprint', function() {
            document.title = "Cetak Laporan Peminjaman - Petugas";
        });
    </script>
</body>
</html>
